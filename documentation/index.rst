...
+==============================+=====================================+=======================================+
| ``base64_decodebytes``       | :func:`py2:base64.decodestring`     | :class:`py3:base64.decodebytes`       |
+------------------------------+-------------------------------------+---------------------------------------+
| ``base64_encodebytes``       | :func:`py2:base64.encodestring`     | :class:`py3:base64.encodebytes`       |
+------------------------------+-------------------------------------+---------------------------------------+
